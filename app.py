...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; }
        ...
        .navbar nav ul li.activo { background-color: #da291c; color: #ffffff; }
...
<body>
    <header class="navbar">
        <div class="nav-contenedor">
            ...
            <nav>
                <ul>
                    <li class="activo" id="tab-servicios">Catálogo de Servicios</li>
                </ul>
            </nav>
        </div>
    </header>
    ...
    <main class="contenedor-principal">
        ...
        <div class="acceso-sesion" id="acceso-sesion">
            ...
            <div class="grupo-entrada">
                ...
                <input type="text" id="usuario" placeholder="Mikolas">
            </div>
            <div class="grupo-entrada">
